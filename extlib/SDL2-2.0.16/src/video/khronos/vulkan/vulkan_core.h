...
VKAPI_ATTR VkResult VKAPI_CALL vkCreateRenderPass(
    ...
    const VkAllocati    ||˜    ûûû÷  “    ŠíÂ   const VkAlloc   const VkAllocationCallbacks*                pAllocator);
...
VKAPI_ATTR VkResult VKAPI_CALL vkBeginCommandBuffer(
    VkCommandBuffer                             commandBufferVKAPI_ATTR VkResVKAPI_ATTR VkResult VKAPI_CALL vkEndCommandBuffer(
...
typedef enum VkAccelerationStructureMemoryRequirementsTypeKHR {
    ...
    VK_ACCELERATION_STRUCTURE_MEMORY_REQUIR    ||ãà<<  ûûû÷  –    h#ÂE_TRIANGLE_FRONT_COUNTERCLOCKWISE_BIT_KHR = 0x00000002,
...
typedef enum VkBuildAccelerationStructureFlagBitsKHR {
    VK_BUILD_ACCELERATION_ 0x00000001,
